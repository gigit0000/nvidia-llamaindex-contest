#This script is adpated from Nvidia demo code.
...
def load_data_from_directory(directory):
    ...
    for filename in os.listdir(directory):
        ...
        # tweak.             
            ...
            try:
                pdf_path = convert_ppt_to_pdf(filepath)
